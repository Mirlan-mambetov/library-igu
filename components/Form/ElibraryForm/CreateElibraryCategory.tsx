...
const CreateElibraryCategory: FC = () => {
	...
	const submitHandler: SubmitHandler<ElibraryCategoryDto> = async (data) => {
		try {
			await createCategory({ id: updateId, data })
				.unwrap()
				.then(() => onClose())
		} catch (err) {
...
export default CreateElibraryCategory
