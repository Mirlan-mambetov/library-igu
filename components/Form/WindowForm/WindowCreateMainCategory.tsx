...
const WindowCreateMainCategory: FC = () => {
	const theme = useTheme()
	const colors = tokens(theme.palette.mode)
	const { onClose } = useContext(MyModalContext)
	const { enqueueSnackbar } = useSnackbar()
	const [createMainCategory, { isLoading }] =
		windowApi.useCreateWindowMainCategoryMutation()
	const {
		register,
		handleSubmit,
		formState: { errors }
...
export default WindowCreateMainCategory
