	...
	const HeroData: HeroI[] = [
		{
			...
			backGround:
				'https://res.cloudinary.com/djzubalr7/image/upload/v1665412442/Library-igu/vestnik_1_y930dg.png',
			subContent: [
				{
					id: 1,
					description: [
				...
				{
					id: 2,
					description: ['ISSN 1561 - 9516 (print)', 'ISSN 1694-8211 (online)'],
					title: 'Свидетельство о перерегистрации ГРО № 000601 от 26.02.2003г.'
				},
	...
	const JurnalData: JurnalI[] = [
		{
			...
			jurnalAbout: {
				image:
					'https://res.cloudinary.com/djzubalr7/image/upload/v1665423857/Library-igu/vestnik-image_1_1_fhv5rb.png',
				subTitle:
					'«Вестник Иссык-Кульского государственного университета» основан в январе 1999 года.',
			...
			information: {
				...
				title:
					'К публикации принимаются статьи на кыргызском, русском, казахском,турецком и английском языках'
			}
		}
	]
	// about vestnik
			...
			isLink: [
				{
					id: 1,
					link: 'http://nbisu.moy.su/_ld/36/3654_IGUKOYLUBAEV201.pdf',
					name: 'Требования по оформлению стайте'
				},
				{
					id: 2,
					link: 'http://nbisu.moy.su/_ld/36/3654_IGUKOYLUBAEV201.pdf',
					name: 'Примеры оформления списка литературы'
				},
				{
					id: 3,
					link: 'http://nbisu.moy.su/_ld/36/3654_IGUKOYLUBAEV201.pdf',
					name: 'Рекомендации по написанию аннотации'
				}
			]
		}
	]
