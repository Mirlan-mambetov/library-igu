	...
	return (
		<Layout title='Информация об обновлении: Продукта'>
			<Box color={colors.blueAccent[900]}>
				<Box>
					<Typography>Обновление: 25.12.2022 00:00</Typography>
					<Typography variant='inherit'>
						Частичное обновление:
						<ul
							style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}
						>
							<li>Добавлена возможность удаления новостей</li>
							<li>Частично изменен внешний вид всего панеля</li>
							<li>Исправлен внешний вид: удален файл (повторяющийся)</li>
							<li>
								Тестирование модулей: Вестник, Труды преподавателей, Электронная
								библиотека - продлена до 30.12.22
							</li>
