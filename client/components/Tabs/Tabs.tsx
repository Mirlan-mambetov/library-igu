...
export const Tabs: FC<TabsProps> = ({ tabs, title }): JSX.Element => {
  // tabs open statement
  ...
  return (
    <div className={classes.tab}>
      <div className={classNames(classes.tabTop, { [classes.active]: active })} onClick={tabHandler}>
        <svg width="8" height="15" viewBox="0 0 8 15" fill="black" xmlns="http://www.w3.org/2000/svg">
