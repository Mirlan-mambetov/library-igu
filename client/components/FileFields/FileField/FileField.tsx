...
export const FileField: FC<BooksI> = ({ createdAt, auhtors, downloaded, link, publishedYear, text, views }): JSX.Element => {
  return (
    <div className={classes.book}>
      <div className={classes.bookAthor}>
        {auhtors.map((auhtor, i) => (
          <Title type='h4' key={i}>{auhtor}</Title>
        ))}
      </div>
