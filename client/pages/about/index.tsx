...
const About: FC = (): JSX.Element => {
  ...
  const TabsData: TabsInterface[] = [
    { id: 1, title: 'правила пользования', isLink: [{ id: 1, name: 'Вы можете ознакомится правилами пользования', link: '/rules' }] },
    { id: 2, title: 'фонд библиотеки', isLink: [{ id: 1, name: 'Книжный фонд - PDF', link: 'http://nbisu.moy.su/_ld/36/3654_IGUKOYLUBAEV201.pdf' }, { id: 2, name: 'Подписка на периодические издания (2019 год) - PDF', link: 'http://nbisu.moy.su/_ld/36/3654_IGUKOYLUBAEV201.pdf' }] }
  ]
  return (
    <>
      <NextSeo
      ...
      <section className={styles.info} style={{ backgroundImage: `url(https://res.cloudinary.com/djzubalr7/image/upload/v1665335114/Library-igu/2_1_ihlgty.png)` }}>
        <div className="container">
